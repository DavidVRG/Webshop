...
export default function Search() {
    ...
    return (
        <main className='my-12 md:my-24 w-[95%] lg:w-[80%] mx-auto'>
            ...
            <h1 className="text-center lg:text-start text-3xl lg:text-4xl font-semibold capitalize-first border-b-[1px] pb-12 border-neutral-200">Search Products</h1>

            <section className='mt-14 flex flex-wrap justify-center gap-8'>
                {products.map((product) => {
                    if (product.data.title.toLowerCase().includes(state.text.toLowerCase())) {
                        return (
